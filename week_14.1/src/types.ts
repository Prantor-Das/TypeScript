...
// Create a type Managers that has two properties: name of type string and department of type string.
type Managers = {
    name: string;
    department: string;
};
...
// Create a type Team_Lead that is a combination of Employee and Manager.
type Team_Lead = Employees & Managers; // & is called intersection in TypeScript

// Create a variable teamLead of type Team_Lead and initialize it with an object that has the following properties:
